                        ...
                        <form class="navbar-form navbar-right">
                            <div class="form-group">
                                <select class="form-select" id="search-type">
                                    <option value="search">За назвою</option>
                                    <option value="year">За роком випуску</option>
                                    <option value="author">За ID автора</option>
                                </select>
                                ...
                                <script>
                                    $("#search").bind("keypress", function (e) {
                                        if (e.keyCode === 13) {
                                            e.preventDefault()
                                            window.location.replace(`http://level3-lib.com/?${$('#search-type').find(":selected").val()}=${$('#search').val()}`)
                                        }
                                    })
                                </script>
                                <div class="loader"><img src="<?= $static ?>/loading.gif"></div>
